    ...
    <Box sx={{ display: 'flex', gap: 5, flexDirection: 'column' }}>
      <Grid container spacing={2}>
        ...
        <Grid sx={{ display: 'flex', alignItems: 'center' }} size={{ xs: 12, md: 6 }}>
          <Typography>
            In Munich in Obergiesing-Fasangarten, the stylish Salon Mestetique offers you everything
            you need for your beauty. Forget the stress of everyday life and let yourself be
            pampered with the all-encompassing beauty program.
            <br />
            <br />
